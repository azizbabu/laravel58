...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue_spinner_src_ClipLoader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-spinner/src/ClipLoader */ "./node_modules/vue-spinner/src/ClipLoader.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ClipLoader: vue_spinner_src_ClipLoader__WEBPACK_IMPORTED_MODULE_0__["default"],
    'vuejs-datepicker': vuejs_datepicker__WEBPACK_IMPORTED_MODULE_1__["default"],
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPostList: function getPostList() {
      ...
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      axios.get(this.siteUrl + '/api/posts?page=' + page).then(function (response) {
    ...
    showPostCreateForm: function showPostCreateForm() {
      this.isAddPost = true;
      this.errors = [];
      $('#postModal').modal();
    },
      ...
      axios.post("".concat(this.siteUrl, "/api/posts"), this.post).then(function (response) {
        if (response.data.success) {
          setTimeout(function () {
            ...
            _this2.resetPostData();

            $('#postModal').modal('hide');
            _this2.isAddPost = false;
            _this2.errors = [];
      ...
      axios.patch("".concat(this.siteUrl, "/api/posts/").concat(this.post.id), this.post).then(function (response) {
        if (response.data.success) {
          setTimeout(function () {
            ...
            _this3.resetPostData();

            _this3.isPostList = true;
            _this3.isAddPost = false;
            _this3.errors = [];
    ...
    deletePost: function deletePost(id) {
      ...
      var confirmMsg = confirm('Are you sure to delete this post?');
      ...
      this.isLoading = true;
      axios["delete"]("".concat(this.siteUrl, "/api/posts/").concat(id)).then(function (response) {
        if (response.data.success) {
          _this4.$toasted.success(response.data.message, {
            position: 'top-center',
            theme: 'bubble',
          ...
          var i = _this4.posts.data.map(function (item) {
            return item.id;
          }).indexOf(id); // find index of your object


          _this4.posts.data.splice(i, 1); // remove one post with i index
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/AddLibrary.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/libraries/AddLibrary.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addLibrary: function addLibrary() {
      var _this = this;

      _this.isLoading = true;
      var siteUrl = document.querySelector("meta[name='site-url']").getAttribute("content");
      axios.post("".concat(siteUrl, "/api/library/create"), _this.library).then(function (response) {
        if (response.data.success) {
          setTimeout(function () {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/AllLibraries.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/libraries/AllLibraries.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    var siteUrl = document.querySelector("meta[name='site-url']").getAttribute("content");
    axios.get(siteUrl + '/api/libraries').then(function (response) {
  ...
  methods: {
    deleteLibrary: function deleteLibrary(id) {
      ...
      var confirmMsg = confirm('Are you sure to delete this library?');
      ...
      this.isLoading = true;
      var siteUrl = document.querySelector("meta[name='site-url']").getAttribute("content");
      axios["delete"]("".concat(siteUrl, "/api/library/delete/").concat(id)).then(function (response) {
        if (response.data.success) {
          _this2.$toasted.success(response.data.message, {
            position: 'top-center',
            theme: 'bubble',
          ...
          var i = _this2.libraries.map(function (item) {
            return item.id;
          }).indexOf(id); // find index of your object


          _this2.libraries.splice(i, 1);
        } else {
          _this2.$toasted.error(response.data.message, {
            position: 'top-center',
            theme: 'bubble',
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/EditLibrary.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/libraries/EditLibrary.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updateLibrary: function updateLibrary() {
      ...
      _this.isLoading = true;
      var siteUrl = document.querySelector("meta[name='site-url']").getAttribute("content");
      axios.patch("".concat(siteUrl, "/api/library/update/").concat(this.$route.params.id), this.library).then(function (response) {
        if (response.data.success) {
          setTimeout(function () {
            _this.$toasted.success(response.data.message, {
              position: 'top-center',
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "text-center" }, [
      _c("h3", [_c("a", { attrs: { href: "#/" } }, [_vm._v("Test Vue")])]),
      _vm._v(" "),
      _c("span", { staticClass: "text-secondary" }, [
        _vm._v("Laravel & Vue CRUD single Page Application(SPA)")
      ])
    ])
  }
]
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "company-wrapper" } }, [
    _vm.isLoading
      ? _c("div", [
          _c(
            "div",
    ...
    _vm._v(" "),
    _vm.isCompanyList
      ? _c("div", { attrs: { id: "companyListArea" } }, [
          _c("h3", [
              ...
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    ...
                    return _vm.showCompanyCreateForm($event)
                  }
                }
              },
              [_vm._v("Add New")]
            ...
            [
              _c("table", { staticClass: "table table-bordered" }, [
                ...
                _c(
                  "tbody",
                  [
                    _vm.companies.hasOwnProperty("data") &&
                    _vm.companies.data.length
                      ? _vm._l(_vm.companies.data, function(company) {
                          return _c("tr", { key: company.id }, [
                            ...
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(company.owner_name))]),
                            _vm._v(" "),
                            _c("td", [
                              _vm._v(_vm._s(_vm.companyTypeList[company.type]))
                            ]),
                            _vm._v(" "),
                                  ...
                                  _c(
                                    "button",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          $event.preventDefault()
                                          return _vm.showEditForm(company.id)
                                        }
                                      }
                                    },
                                    [_vm._v("Edit")]
              ...
              _c("pagination", {
                ...
                on: { "pagination-change-page": _vm.getCompanyList }
              })
            ],
            1
          )
                  ...
                  [
                    ...
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.company.owner_name,
                            expression: "company.owner_name"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: {
                        ...
                        domProps: { value: _vm.company.owner_name },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                      ...
                      _vm._v(" "),
                      _vm.errors.owner_name
                        ? _c("div", { staticClass: "text-danger" }, [
                            _vm._v(
                              "\n\t\t\t\t\t\t\t\t" +
                                _vm._s(_vm.errors.owner_name[0]) +
                                "\n\t\t\t\t\t\t\t"
                            )
                          ])
                        : _vm._e()
                    ...
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.company.owner_phone,
                            expression: "company.owner_phone"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: {
                        ...
                        domProps: { value: _vm.company.owner_phone },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                      ...
                      _vm._v(" "),
                      _vm.errors.owner_phone
                        ? _c("div", { staticClass: "text-danger" }, [
                            _vm._v(
                              "\n\t\t\t\t\t\t\t\t" +
                                _vm._s(_vm.errors.owner_phone[0]) +
                                "\n\t\t\t\t\t\t\t"
                            )
                          ])
                        : _vm._e()
                    ...
                    _c(
                      ...
                      [
                        _c("label", { attrs: { for: "company-types" } }, [
                          _vm._v("Company Types:")
                        ]),
                        _vm._v(" "),
                        _c("v-select", {
                          attrs: {
                    ...
                    _c(
                      ...
                      { staticClass: "form-group" },
                      [
                        _c("label", { attrs: { for: "establish_date" } }, [
                        ...
                        _c("vuejs-datepicker", {
                          ...
                          model: {
                            value: _vm.company.establish_date,
                            callback: function($$v) {
                              _vm.$set(_vm.company, "establish_date", $$v)
                            },
                            expression: "company.establish_date"
                          }
                        }),
                        _vm._v(" "),
                        _vm.errors.establish_date
                          ? _c("div", { staticClass: "text-danger" }, [
                              _vm._v(
                                "\n\t\t\t\t\t\t\t\t" +
                                  _vm._s(_vm.errors.establish_date[0]) +
                                  "\n\t\t\t\t\t\t\t"
                              )
                            ])
                          : _vm._e()
                    ...
                    _c(
                      ...
                      [
                        ...
                        _vm.errors.logo
                          ...
                          : _vm._e(),
                        _vm._v(" "),
                        !_vm.isAddCompany && this.company.logo
                          ? [
                              _c("img", {
                                attrs: {
                                  src:
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "post-wrapper" } }, [
    _vm.isLoading
      ? _c("div", [
          _c(
            "div",
            ...
            _c(
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    $event.preventDefault()
                    return _vm.showPostCreateForm($event)
                  }
                }
              },
              [_vm._v("Add New")]
            ...
            [
              _c("table", { staticClass: "table table-bordered" }, [
                ...
                _c(
                  "tbody",
                  [
                    _vm.posts.hasOwnProperty("data") && _vm.posts.data.length
                      ? _vm._l(_vm.posts.data, function(post) {
                          return _c("tr", { key: post.id }, [
                            _c("td", [_vm._v(_vm._s(post.title))]),
                            _vm._v(" "),
                            _c("td", [
                              _vm._v(_vm._s(_vm.postTypeList[post.type]))
                            ]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(post.post_date))]),
                            _vm._v(" "),
                            _c("td", [
                              _vm._v(
                                _vm._s(
                                  ...
                                  _c(
                                    "button",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          $event.preventDefault()
                                          return _vm.showEditForm(post.id)
                                        }
                                      }
                                    },
                                    [_vm._v("Edit")]
              ...
              _c("pagination", {
                ...
                on: { "pagination-change-page": _vm.getPostList }
              })
            ],
            1
          )
                ...
                _c("div", { staticClass: "modal-body" }, [
                    ...
                    [
                      ...
                      _c("v-select", {
                        attrs: {
                          ...
                          value: _vm.$store.getters.getPost.type,
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm.errors.post_date
                        ? _c("div", { staticClass: "text-danger" }, [
                            _vm._v(
                              "\n                                    " +
                                _vm._s(_vm.errors.post_date[0]) +
                                "\n                                "
                            )
                          ])
                        : _vm._e()
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", [_vm._v("Title")]),
        _vm._v(" "),
        _c("th", { attrs: { width: "7%" } }, [_vm._v("Type")]),
        _vm._v(" "),
        _c("th", { attrs: { width: "10%" } }, [_vm._v("Posted Date")]),
        _vm._v(" "),
        _c("th", { attrs: { width: "22%" } }, [_vm._v("Created at")]),
        _vm._v(" "),
        _c("th", [_vm._v("Actions")])
      ])
    ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/AddLibrary.vue?vue&type=template&id=38fcc2fb&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/libraries/AddLibrary.vue?vue&type=template&id=38fcc2fb& ***!
  \***********************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "addLibraryArea" } }, [
    _vm.isLoading
      ? _c("div", [
          _c(
            "div",
      ...
      : _vm._e(),
    _vm._v(" "),
    _c("h3", { staticClass: "text-center" }, [_vm._v("Add Library")]),
    _vm._v(" "),
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-md-6" }, [
        _c(
          ...
          [
              ...
              _c("input", {
                ...
                on: {
                  input: function($event) {
                    ...
                    _vm.$set(_vm.library, "title", $event.target.value)
                  }
                }
              }),
              _vm._v(" "),
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.library.owner,
                    expression: "library.owner"
                  }
                ],
                staticClass: "form-control",
                attrs: {
                ...
                domProps: { value: _vm.library.owner },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.library, "owner", $event.target.value)
                  }
                }
              }),
              _vm._v(" "),
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("textarea", {
                ...
                domProps: { value: _vm.library.description },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.library, "description", $event.target.value)
                  }
                }
              })
            ]),
            ...
            _c(
              ...
              { staticClass: "form-group" },
              [
                _c("label", { attrs: { for: "library-types" } }, [
                  _vm._v("Library Types:")
                ]),
                _vm._v(" "),
                _c("v-select", {
                  attrs: {
            ...
            _c(
              ...
              [
                ...
                _c("vuejs-datepicker", {
                  ...
                  model: {
                    value: _vm.library.establish_date,
                    callback: function($$v) {
                      _vm.$set(_vm.library, "establish_date", $$v)
                    },
                    expression: "library.establish_date"
                  }
                }),
                _vm._v(" "),
                _vm.errors.establish_date
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/AllLibraries.vue?vue&type=template&id=4c63b24e&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/libraries/AllLibraries.vue?vue&type=template&id=4c63b24e& ***!
  \*************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "libraryListArea" } }, [
    _vm.isLoading
      ? _c("div", [
          _c(
            "div",
      ...
      : _vm._e(),
    _vm._v(" "),
    _c("h3", { staticClass: "text-center" }, [_vm._v("All Libraries")]),
    _vm._v(" "),
        ...
        _c(
          ...
          [
            _vm.libraries.length
              ? _vm._l(_vm.libraries, function(library) {
                  return _c("tr", { key: library.id }, [
                    _c("td", [_vm._v(_vm._s(library.title))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(library.owner))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(_vm.libraryTypes[library.type]))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(library.establish_date))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(library.created_at))]),
                    _vm._v(" "),
                    _c("td", [
                      _c(
                        "div",
                        ...
                        [
                          _c(
                            "router-link",
                            {
                              staticClass: "btn btn-primary",
                              attrs: {
                                to: { name: "edit", params: { id: library.id } }
                              }
                            },
                            [_vm._v("Edit")]
                          ),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/EditLibrary.vue?vue&type=template&id=10e57200&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/libraries/EditLibrary.vue?vue&type=template&id=10e57200& ***!
  \************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "editLibraryArea" } }, [
    _vm.isLoading
      ? _c("div", [
          _c(
            "div",
      ...
      : _vm._e(),
    _vm._v(" "),
    _c("h3", { staticClass: "text-center" }, [_vm._v("Edit Library")]),
    _vm._v(" "),
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-md-6" }, [
        _c(
          "form",
          {
            on: {
              submit: function($event) {
                $event.preventDefault()
                return _vm.updateLibrary($event)
              }
            }
          },
          [
                  ...
                  scopedSlots: _vm._u([
                    {
                      ...
                      fn: function(option) {
                        return [
                          _c("span", {
                            domProps: { innerHTML: _vm._s(option.valueNoImage) }
                          }),
                          _vm._v(
                            "\n\t\t\t\t\t\t\t\t" +
                              _vm._s(option.label) +
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "text-center", attrs: { id: "not-found" } },
    [
      _c("h1", [_vm._v("Oops!")]),
      _vm._v(" "),
      ...
      _vm._v(" "),
      _c("p", [
        _vm._v("Sorry, an error has occured, Requested page not found!")
      ]),
      _vm._v(" "),
      _c(
        "router-link",
        { staticClass: "btn btn-primary", attrs: { to: { name: "/" } } },
        [_vm._v("Take me Home")]
      )
    ],
    1
...
/***/ "./resources/js/components/libraries/AddLibrary.vue":
/*!**********************************************************!*\
  !*** ./resources/js/components/libraries/AddLibrary.vue ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _AddLibrary_vue_vue_type_template_id_38fcc2fb___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AddLibrary.vue?vue&type=template&id=38fcc2fb& */ "./resources/js/components/libraries/AddLibrary.vue?vue&type=template&id=38fcc2fb&");
/* harmony import */ var _AddLibrary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AddLibrary.vue?vue&type=script&lang=js& */ "./resources/js/components/libraries/AddLibrary.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _AddLibrary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _AddLibrary_vue_vue_type_template_id_38fcc2fb___WEBPACK_IMPORTED_MODULE_0__["render"],
  _AddLibrary_vue_vue_type_template_id_38fcc2fb___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/libraries/AddLibrary.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/libraries/AddLibrary.vue?vue&type=script&lang=js&":
/*!***********************************************************************************!*\
  !*** ./resources/js/components/libraries/AddLibrary.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AddLibrary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./AddLibrary.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/AddLibrary.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AddLibrary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/libraries/AddLibrary.vue?vue&type=template&id=38fcc2fb&":
/*!*****************************************************************************************!*\
  !*** ./resources/js/components/libraries/AddLibrary.vue?vue&type=template&id=38fcc2fb& ***!
  \*****************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AddLibrary_vue_vue_type_template_id_38fcc2fb___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./AddLibrary.vue?vue&type=template&id=38fcc2fb& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/AddLibrary.vue?vue&type=template&id=38fcc2fb&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AddLibrary_vue_vue_type_template_id_38fcc2fb___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AddLibrary_vue_vue_type_template_id_38fcc2fb___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/libraries/AllLibraries.vue":
/*!************************************************************!*\
  !*** ./resources/js/components/libraries/AllLibraries.vue ***!
  \************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _AllLibraries_vue_vue_type_template_id_4c63b24e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AllLibraries.vue?vue&type=template&id=4c63b24e& */ "./resources/js/components/libraries/AllLibraries.vue?vue&type=template&id=4c63b24e&");
/* harmony import */ var _AllLibraries_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AllLibraries.vue?vue&type=script&lang=js& */ "./resources/js/components/libraries/AllLibraries.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _AllLibraries_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _AllLibraries_vue_vue_type_template_id_4c63b24e___WEBPACK_IMPORTED_MODULE_0__["render"],
  _AllLibraries_vue_vue_type_template_id_4c63b24e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/libraries/AllLibraries.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/libraries/AllLibraries.vue?vue&type=script&lang=js&":
/*!*************************************************************************************!*\
  !*** ./resources/js/components/libraries/AllLibraries.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AllLibraries_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./AllLibraries.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/AllLibraries.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AllLibraries_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/libraries/AllLibraries.vue?vue&type=template&id=4c63b24e&":
/*!*******************************************************************************************!*\
  !*** ./resources/js/components/libraries/AllLibraries.vue?vue&type=template&id=4c63b24e& ***!
  \*******************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AllLibraries_vue_vue_type_template_id_4c63b24e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./AllLibraries.vue?vue&type=template&id=4c63b24e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/AllLibraries.vue?vue&type=template&id=4c63b24e&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AllLibraries_vue_vue_type_template_id_4c63b24e___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AllLibraries_vue_vue_type_template_id_4c63b24e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/libraries/EditLibrary.vue":
/*!***********************************************************!*\
  !*** ./resources/js/components/libraries/EditLibrary.vue ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _EditLibrary_vue_vue_type_template_id_10e57200___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EditLibrary.vue?vue&type=template&id=10e57200& */ "./resources/js/components/libraries/EditLibrary.vue?vue&type=template&id=10e57200&");
/* harmony import */ var _EditLibrary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EditLibrary.vue?vue&type=script&lang=js& */ "./resources/js/components/libraries/EditLibrary.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _EditLibrary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _EditLibrary_vue_vue_type_template_id_10e57200___WEBPACK_IMPORTED_MODULE_0__["render"],
  _EditLibrary_vue_vue_type_template_id_10e57200___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/libraries/EditLibrary.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/libraries/EditLibrary.vue?vue&type=script&lang=js&":
/*!************************************************************************************!*\
  !*** ./resources/js/components/libraries/EditLibrary.vue?vue&type=script&lang=js& ***!
  \************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EditLibrary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./EditLibrary.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/EditLibrary.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EditLibrary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/libraries/EditLibrary.vue?vue&type=template&id=10e57200&":
/*!******************************************************************************************!*\
  !*** ./resources/js/components/libraries/EditLibrary.vue?vue&type=template&id=10e57200& ***!
  \******************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditLibrary_vue_vue_type_template_id_10e57200___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./EditLibrary.vue?vue&type=template&id=10e57200& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/libraries/EditLibrary.vue?vue&type=template&id=10e57200&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditLibrary_vue_vue_type_template_id_10e57200___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditLibrary_vue_vue_type_template_id_10e57200___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/*!********************************!*\
  !*** ./resources/js/config.js ***!
  \********************************/
/*! exports provided: siteUrlMain */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "siteUrlMain", function() { return siteUrlMain; });
var siteUrl = document.querySelector("meta[name='site-url']").getAttribute("content");
var getUrl = window.location;
var siteUrlPrependInfo = getUrl.protocol + "//" + getUrl.host + "/";
var siteUrlMain = siteUrl.replace(siteUrlPrependInfo, '');
...
/* harmony import */ var _components_libraries_AllLibraries_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/libraries/AllLibraries.vue */ "./resources/js/components/libraries/AllLibraries.vue");
/* harmony import */ var _components_libraries_AddLibrary_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/libraries/AddLibrary.vue */ "./resources/js/components/libraries/AddLibrary.vue");
/* harmony import */ var _components_libraries_EditLibrary_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/libraries/EditLibrary.vue */ "./resources/js/components/libraries/EditLibrary.vue");
/* harmony import */ var _components_Companies_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/Companies.vue */ "./resources/js/components/Companies.vue");
...
var routes = [{
  name: 'home',
  path: '/',
  component: _components_libraries_AllLibraries_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
}, {
  name: 'add',
  path: '/add',
  component: _components_libraries_AddLibrary_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
}, {
  name: 'edit',
  path: '/edit/:id',
  component: _components_libraries_EditLibrary_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
}, {
  name: 'companies',
  path: '/companies',
  component: _components_Companies_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
}, {
  name: 'posts',
  path: '/posts',
  component: _components_Posts_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
}, {
  name: '404',
  path: '*',
...
/* harmony import */ var vue_ckeditor2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-ckeditor2 */ "./node_modules/vue-ckeditor2/dist/vue-ckeditor2.esm.js");
...
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./config */ "./resources/js/config.js");
...
Vue.use(vue_ckeditor2__WEBPACK_IMPORTED_MODULE_3__["default"]);
Vue.use(vue_toasted__WEBPACK_IMPORTED_MODULE_4___default.a);
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  base: _config__WEBPACK_IMPORTED_MODULE_8__["siteUrlMain"] + '/test-vue/',
  fallback: true
});
var app = new Vue({
  el: '#app',
...
/***/ 1:
/*!****************************************!*\
  !*** multi ./resources/js/test-vue.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! F:\xampp\htdocs\laravel58\resources\js\test-vue.js */"./resources/js/test-vue.js");
